...
<section class="services">
  ...
  <div class="max-w-screen-xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 md:col-gap-8 md:row-gap-10 flex flex-row items-center justify-center">
    ...
    <div class="">
      <div class="h-full mx-auto rounded bg-cover bg-right shadow-lg" style="min-height:450px; background-image:url(https://images.pexels.com/photos/1043473/pexels-photo-1043473.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500);"></div>
    </div>
